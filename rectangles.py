...
"""
    Rect 1: [0.15 0.15] -> [3.45 4.25]
    Rect 2: [0.15 4.25] -> [3.45 9.05]
    Rect 3: [0.15 9.05] -> [3.45 13.3]
    Rect 4: [3.45 0.15] -> [6.75 4.25]
    Rect 5: [3.45 4.25] -> [6.75 9.05]
    Rect 6: [3.45 9.05] -> [6.75 13.3]
    Rect 7: [6.75 0.15] -> [9.85 4.25]
    Rect 8: [6.75 4.25] -> [9.85 9.05]
    Rect 9: [6.75 9.05] -> [9.85 13.3]
"""
